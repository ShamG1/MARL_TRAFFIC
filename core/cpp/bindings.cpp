...
PYBIND11_MODULE(DRIVESIMX_ENV, m) {
    ...
    m.def("mcts_search_lstm_torchscript_compact", &mcts_search_lstm_torchscript_compact,
        py::arg("env"),
        py::arg("root_state"),
        py::arg("root_obs_seq"),
        py::arg("seq_len"),
    ...
    m.def("mcts_search_to_shm", &mcts_search_to_shm,
        py::arg("env"),
        py::arg("root_state"),
        py::arg("root_obs_seq"),
        py::arg("seq_len"),
        ...
        py::arg("dirichlet_eps"),
        py::arg("seed"),
        py::arg("action_ptr_addr"),
        py::arg("stats_ptr_addr")
    );

    m.def("mcts_search_tcn_torchscript_seq_to_shm", &mcts_search_tcn_torchscript_seq_to_shm,
        py::arg("env"),
        py::arg("root_state"),
        py::arg("root_obs_seq"),
        py::arg("seq_len"),
    ...
    m.def("mcts_search_seq_to_shm", &mcts_search_seq_to_shm,
        py::arg("env"),
        py::arg("root_state"),
        py::arg("root_obs_seq"),
        py::arg("seq_len"),
